...
export const TypewriterEffectSmooth = ({
  ...
  return (
    <div className={cn("flex flex-wrap justify-center gap-x-1 my-6", className)}>
      <motion.div
      ...
      >
        <div className="text-xl sm:text-2xl md:text-4xl xl:text-5xl font-bold" style={{ whiteSpace: "nowrap" }}>
          {renderWords()}
        </div>
      </motion.div>
      <motion.span
